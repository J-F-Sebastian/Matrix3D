...
public:
    ...
    m3d_camera (const m3d_camera& other) :
    ...
    // Project point from camera coordinates to the view plane (frustum near plane)
    void project_to_viewplane(m3d_point& point);
    ...
    void transform_and_project_to_screen(m3d_point& point, SDL_Point& pix);
